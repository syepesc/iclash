...
#
#     PHX_SERVER=true bin/iclash start
#
...
if(config_env() == :prod) do
  ...
  config :iclash, Iclash.Repo,
    # ssl: true,
    url: database_url,
    # NOTE: Fly.io default max pool_size is 100 (this can be modify, reach them out). Deployment will CRASH if the pool size is greater.
  ...
  config :iclash, :dns_cluster_query, System.get_env("DNS_CLUSTER_QUERY")

  config :iclash, IclashWeb.Endpoint,
